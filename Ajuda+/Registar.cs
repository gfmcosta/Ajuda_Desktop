    ...
    public partial class Registar : Form {
        ...
        private async void button2_Click(object sender, EventArgs e) {
            try {
                ...
                if (textEmail.Text == "" || textNome.Text == "" || textConfirmSenha.Text == "" || comboSexo.Text == "" || textTelemovel.Text == "" || dateTimePicker1.Value.Date > DateTime.Now.Date || textNIF.Text == "" || textSenha.Text == "" || textDocumento.Text == "") {
                    //Form is not valid
                } else {
                    if (textConfirmSenha.Text == textSenha.Text) {
                        //Form is valid
                ...
                MessageBox.Show("Erro. Tente novamente (Request timed out)");
